...
class Application:
    ...
    def __init__(self):
        ...
        self.T2.config(text = "Word : MREC", font = ("Courier", 30))
        ...
        self.T3.config(text = "Sentence :Welcome To Vishesh 2K23",font = ("Courier", 30))
    ...
    def video_loop(self):
        ...
        if ok:
            ...
            predicts = self.spell_checker.correction(self.word)
